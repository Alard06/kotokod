...
def updateV(V, T, f):
    for t in T:
        ...
        V[t[2]][t[1]][0] -= f * sgn
        V[t[2]][t[1]][1] += f * sgn
# первое число - это пропускная способность ребра
# 1 означает. что мы двигаемся по стрелке от одной вершины  к другой
# =1 означает. что мы двигаемся против стрелки
# правила формирования матрицы описаны в видео на 24 минуте https://www.youtube.com/watch?v=I0bBIHCaSDo


V = [
    [[0, 0, -1], [3, 2, 1], [2, 0, 1], [0, 0, -1], [0, 0, -1]],
    [[3, 2, -1], [0, 0, -1], [4, 1, 1], [4, 1, 1], [0, 0, -1]],
    [[0, 2, -1], [4, 1, -1], [0, 0, -1], [2, 1, 1], [3, 0, 1]],
    [[0, 0, -1], [4, 1, -1], [2, 1, -1], [0, 0, -1], [2, 2, 1]],
    [[0, 0, -1], [0, 0, -1], [3, 0, -1], [2, 2, -1], [0, 0, -1]]
]

N = len(V)  # число вершин в графе
init = 0    # вершина истока (нумерация с нуля)              ЭТО ВАЖНО!!!
end = 4     # вершина стока                                  ЭТО ВАЖНО!!!
